...
export const MAX_TROOP_SIZE = 100; // 阵容上限（金币场最高档 100 → 100 词）

/**
 * 💰 金币场：押注金币 → 每方出战单词数（2026-09-18 拍板）
 * **词数 = 押注金币数**（1 币 = 1 词）：10→10 / 20→20 / 50→50 / 100→100。
 * 档位由 BET_OPTIONS 定义；此处表仅作兼容/展示（未列档位直接按 bet 取）。
 */
